(function() {
  ...
  function toggleClass() {
    ...
    className = className.replace(/(pointerfocus|utilityfocus)/, '').replace(/\s\s/, ' ');
    doc.className = ' ' + (isPointer? 'pointerfocus' : 'utilityfocus');
  }
...
// FF Mac и Safari не ставят фокус большинству контролов по событиям мыши.
...
// по радиогруппе, события на контроле наступают в такой последовательности:
